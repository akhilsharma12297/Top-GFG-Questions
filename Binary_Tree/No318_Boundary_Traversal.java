...
public class No318_Boundary_Traversal {
	...
	public No318_Boundary_Traversal(int[] arr) {

		Stack<Node> stack = new Stack<No318_Boundary_Traversal.Node>();
	...
	public static void main(String[] args) {
		...
		No318_Boundary_Traversal bt = new No318_Boundary_Traversal(arr);
