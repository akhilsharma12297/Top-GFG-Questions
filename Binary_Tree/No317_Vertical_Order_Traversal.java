...
public class No317_Vertical_Order_Traversal {
	...
	public No317_Vertical_Order_Traversal(int[] arr) {

		Stack<Node> stack = new Stack<No317_Vertical_Order_Traversal.Node>();
	...
	public static void main(String[] args) {
		...
		No317_Vertical_Order_Traversal bt = new No317_Vertical_Order_Traversal(arr);
